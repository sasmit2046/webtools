...
const App={
    ...
    menu:[
        ...
        {s:'SYSTEM'},{id:'users',icon:'fa-users-cog',label:'User Management',admin:1},{id:'settings',icon:'fa-cogs',label:'Settings',admin:1},{id:'notifications',icon:'fa-bell',label:'Notifications'}
    ],
    login(){
